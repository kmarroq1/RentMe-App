...
{
    /// <summary>
    /// model class used to define furniture with inventory
    /// Author: cs6232-g5
    /// Version: Spring 2022
    /// </summary>
    public class FurnitureInventory
    {
        ...
        /// <summary>
        /// constructor used to create furniture with inventory
        /// </summary>
        ...
        /// <param name="quantity">furniture quantity</param>
        public FurnitureInventory(int furnitureID, string name, string description, decimal daily_rental_rate,
            decimal daily_fine_rate, string style_name, string category_name, string image_small_url, string image_large_url, int quantity)
        {
            if (furnitureID < 0)
            {
